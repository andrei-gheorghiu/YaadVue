...
<!-----First Row--->
  <b-row>
    <b-col class="text-right" style="font-size:15px"> <b>CREDIT CARD</b>
       </b-col>
    <b-col cols='3'>
...
<b-card class="mr-2 mb-3 border-0" style="max-width: 800px; min-length: 500px;" bg-variant="transparent" text-variant="white" title="" >
  <b-card-text>
    <b-card id="card2" bg-variant="info" text-variant="white">
  <b-card-text>
      <!---Date---><span class="text-right"><h4>CARD</h4></span>
             <div class="h-50">
                           <!---Payto--->
             <b-row class="mt-4">
      ...
      ></b-form-input>
         ...
         <b-col></b-col>
             ...
             <b-row class="h-50">
                      <b-col cols='8' class="text-right" style="font-size:18px">
            Date
         </b-col>
...
export default {
  ...
  data: () => ({
    selected: 'first',
    options: [
      { text: 'Purchase/Charge', value: 'first' },
      { text: 'Refund/Credit', value: 'second' }
    ],
    items: [
    ...
    dropdownBar: [{
      ...
      items: [
        ...
        null,
        { name: 'Pay Credit Card Bill', icon: 'FileMinusIcon' },
        null,
